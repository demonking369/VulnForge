...
class ReportGenerator:
    ...
    def generate_reports(
        self, context: Dict[str, Any], output_format: str = "all"
    ) -> Dict[str, str]:
    ...
    def _generate_html_report(self, context: Dict[str, Any]) -> Path:
        ...
        try:
            ...
            <footer style="text-align: center; margin-top: 2rem; padding: 1rem; border-top: 1px solid #e5e7eb;">
                <p>Generated by NeuroRift | Author: DemonKing369.0</p>
                <p>GitHub: <a href="https://github.com/Arunking9">https://github.com/Arunking9</a></p>
            </footer>
            """
            html_content = html_content.replace("</body>", f"{watermark_footer}</body>")
    ...
    def _generate_markdown_report(self, context: Dict[str, Any]) -> Path:
        ...
        try:
            ...
            watermark_footer = f"""
---
Generated by NeuroRift | Author: DemonKing369.0
GitHub: https://github.com/Arunking9
"""
            md_content += watermark_footer
