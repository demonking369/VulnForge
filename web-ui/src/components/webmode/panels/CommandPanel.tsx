            ...
            <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1.2fr)_minmax(0,1fr)] gap-4">
                ...
                <div className="space-y-4">
                    <div className="rounded-xl border border-neuro-border/60 bg-neuro-bg/60 p-4">
                        <h4 className="text-xs uppercase tracking-[0.4em] text-neuro-text-muted mb-3">Quick Commands</h4>
                        <div className="space-y-2">
                            {COMMAND_PRESETS.map(preset => (
                                <button
                                    key={preset}
                                    onClick={() => submitMessage(preset)}
                                    className="w-full px-3 py-2 rounded-lg bg-neuro-surface/80 border border-neuro-border/60 text-xs text-neuro-text-secondary hover:text-neuro-text-primary hover:border-cyan-400/40 transition"
                                >
                                    {preset}
                                </button>
                            ))}
