...
class MetasploitTool(BaseTool):
    ...
    def validate_input(self, input_data: ToolInput) -> bool:
        ...
        return bool(input_data.args.get("resource_script") or input_data.args.get("command"))
    ...
    def parse_output(self, raw_output: str) -> Dict[str, Any]:
        ...
        success = "Meterpreter session" in raw_output or "Command shell session" in raw_output
        return {
