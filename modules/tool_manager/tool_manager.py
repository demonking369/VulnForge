...
class ToolManager:
    ...
    def install_tool(self, tool_name: str) -> Dict[str, Any]:
        ...
        with Progress(
            ...
            try:
                ...
                return {
                    "success": False,
                    "error": f"Failed to download tool: {str(e)}"
                }
            ...
            try:
                ...
                return {
                    "success": False,
                    "error": f"Failed to install tool: {str(e)}"
                }
    ...
    def _install_tool_files(self, tool_name: str, download_path: Path, tool_config: Dict) -> None:
        """Install tool files"""
        tool_dir = self.tools_dir / tool_name
    ...
    def update_tool(self, tool_name: str) -> Dict[str, Any]:
        ...
        with Progress(
            ...
            if not self._verify_installation(tool_name, tool_config):
                ...
                return {
                    "success": False,
                    "error": f"Failed to verify new installation"
                }
            progress.update(task, completed=True)
    ...
    def uninstall_tool(self, tool_name: str) -> Dict[str, Any]:
        ...
        with Progress(
            ...
            try:
                ...
                return {
                    "success": False,
                    "error": f"Failed to remove tool: {str(e)}"
                }
            ...
            return {
                "success": True,
                "message": f"Successfully uninstalled {tool_name}"
            }
    ...
    def list_tools(self) -> Dict[str, Any]:
        ...
        for tool_name, tool_config in self.tools_config.items():
            tools[tool_name] = {
                ...
                "version": self._get_tool_version(tool_name) if self._is_tool_installed(tool_name) else None,
