    ...
    async def analyze_scan_results(self, results_file: Path):
        ...
        try:
            ...
            try:
                ...
                # Save analysis
                output_path = self.base_dir / "data" / "analysis" / f"analysis_{Path(results_file).stem}.json"
            ...
            try:
                ...
                if exploit_data and "error" not in exploit_data:
                    ...
                    if validation["syntax_valid"] and validation["has_error_handling"]:
                        ...
                        metasploit_module = generator.generate_metasploit_module(exploit_data)
                        ...
                        await self.notifier.notify(
                            ...
                            data={
                                ...
                                "metasploit_module": str(metasploit_module) if metasploit_module else None,
...
async def main():
    ...
    latest_result = max(results_dir.glob("recon_*.json"), key=lambda p: p.stat().st_mtime)
