...
class PerformanceAnalyzer:
        ...
        for target in test_targets:
            ...
            for operation in native_times:
                if operation in python_times:
                    speedup[operation] = python_times[operation] / native_times[operation]
    ...
    def generate_report(self) -> str:
        ...
        report = {
            ...
            "summary": self._generate_summary(ai_analysis, native_audit, tool_analysis, speed_benchmarks)
        }
    ...
    def _generate_summary(self, ai_analysis, native_audit, tool_analysis, speed_benchmarks):
